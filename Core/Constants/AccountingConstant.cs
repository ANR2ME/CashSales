...
namespace Core.Constants
{
    public partial class Constant
    {
        ...
        public class AccountLegacyCode
        {
            ...
            public static string Expense = "E1";
            public static string COGS = "E11";
            public static string CashBankAdjustmentExpense = "E12";
            public static string Discount = "E13";
            public static string SalesAllowance = "E14";
            public static string StockAdjustmentExpense = "E15";
