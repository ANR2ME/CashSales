$(document).ready(function () {
	...
	$("#list").jqGrid({
		...
		colModel: [
				  ...
				  { name: 'cogs', index: 'cogs', width: 80, formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0' } },
                  { name: 'profitloss', index: 'profitloss', width: 80, formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0' } },
	...
	$('#btn_confirm').click(function () {
		...
		if (id) {
			...
			$('#ConfirmationDate').datebox('setValue', ret.salesdate);
	...
	$("#listdetail").jqGrid({
		...
		colModel: [
				  ...
				  { name: 'cogs', index: 'cogs', width: 100, formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0' }, sortable: false },
                  ...
                  { name: 'assignedprice', index: 'assignedprice', width: 100, formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0' }, sortable: false },
		],
		page: '1',
		pager: $('#pagerdetail'),
		rowNum: 20,
