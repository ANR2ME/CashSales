$(document).ready(function () {
	...
	$("#listdetail").jqGrid({
		...
		colModel: [
				  ...
				  { name: 'totalprice', index: 'totalprice', width: 100, formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 0, prefix: "", suffix: "", defaultValue: '0' }, sortable: false },
		],
		page: '1',
		pager: $('#pagerdetail'),
		rowNum: 20,
