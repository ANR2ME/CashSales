$(document).ready(function () {
	...
	$("#list").jqGrid({
		...
		colModel: [
                  ...
                  { name: 'allowance', index: 'allowance', width: 80, formatter: 'currency', formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0' } },
                  { name: 'total', index: 'total', width: 80, formatter: 'currency', formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0' } },
				  ...
				  { name: 'confirmationdate', index: 'confirmationdate', hidden:true, search: false, width: 120, align: "center", formatter: 'date', formatoptions: { srcformat: 'Y-m-d', newformat: 'Y/m/d' } },
                  ...
                  { name: 'paymentdate', index: 'paymentdate', hidden: true, search: false, width: 100, align: "center", formatter: 'date', formatoptions: { srcformat: 'Y-m-d', newformat: 'Y/m/d' } },
	...
	$("#listdetail").jqGrid({
		...
		colModel: [
				  ...
				  { name: 'totalprice', index: 'totalprice', width: 100, formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0' } },
                  { name: 'cogs', index: 'cogs', width: 100, formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0' } },
		],
		page: '1',
		pager: $('#pagerdetail'),
		rowNum: 20,
	...
	jQuery("#lookup_table_cashsalesinvoice").jqGrid({
		...
		colModel: [
                  ...
                  { name: 'shippingfee', index: 'shippingfee', hidden: true, width: 80, formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0' } },
