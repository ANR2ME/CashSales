$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'Company/GetList', postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "Company/GetInfo?Id=" + id,
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'Company/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'Company/Insert';
        }
