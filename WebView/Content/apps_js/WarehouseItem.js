$(document).ready(function () {
    ...
    function ReloadGridViewWarehouse(id) {
        ...
        $("#list_detail").jqGrid({
            ...
            datatype: "json",
            mtype: 'GET',
            colNames: ['ID', 'Code', 'Name', 'Description', 'Quantity'],
            colModel: [
                      { name: 'id', index: 'id', width: 80, align: "center", frozen: true },
                      { name: 'warehousecode', index: 'warehousecode', width: 80 },
                      { name: 'warehouse', index: 'warehouse', width: 200 },
                      { name: 'warehousedesc', index: 'warehousedesc', width: 250 },
