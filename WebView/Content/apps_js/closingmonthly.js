$(document).ready(function () {
    ...
    $('#btnperiod').click(function () {
        ...
        var lookUpURL = base_url + 'ClosingMonthly/GetListClosingByGL';
        if ($('#rbarap').is(':checked')) {
            lookUpURL = base_url + 'ClosingMonthly/GetListClosingByARAP';
        }
    ...
    $("#posting_form_btn_save").click(function () {
        $.messager.confirm('Confirm', 'Are you sure you want to process Closing Monthly?', function (r) {
            if (r) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: base_url + "ClosingMonthly/Process",
                    data: JSON.stringify({
