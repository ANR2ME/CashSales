$(document).ready(function () {
    ...
    $('#lookup_div_validcombinationcashregional_detail').dialog('close');
    $('#lookup_mstcoa_div').dialog('close');
    //Table GI Detail
    jQuery("#list_validcombinationcashregional").jqGrid({
        datatype: "local",
        height: 80,
        width: 400,
        rowNum: 150,
        scrollrows: true,
        pager: $('#pager_list_validcombinationcashregional'),
        shrinkToFit: false,
    ...
    $('#validcombinationcashregional_form_btn_reload').click(function () {
    ...
    //Open Dialog
    $('#validcombinationcashregional_form_btn_add').click(function () {
        $('#lookup_div_validcombinationcashregional_detail').dialog('open');
    });

    //Close Dialog
    $('#lookup_btn_cancel_validcombinationcashregional_detail').click(function () {
        $('#lookup_div_validcombinationcashregional_detail').dialog('close');
    });
    $('#lookup_btn_add_validcombinationcashregional_detail').click(function () {
        $('#lookup_div_validcombinationcashregional_detail').dialog('close');
    });
