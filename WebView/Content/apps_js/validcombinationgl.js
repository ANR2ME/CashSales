$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#table_detail").setGridParam({ url: base_url + 'ValidCombination/GetValidCombGeneralLedgerList', postData: { filters: null }, page: 'last' }).trigger("reloadGrid");
    }

    //Table Detail
    jQuery("#table_detail").jqGrid({
        url: base_url + 'ValidCombination/GetValidCombGeneralLedgerList',
        datatype: "json",
        colNames: ['Period', 'Year', 'Account Code', 'Title', 'Level', 'Begin Period Closing', 'End Period Closing', 'Current Debit USD',
        ...
        colModel: [
            ...
            { name: 'title', index: 'AccountName', width: 200 },
        ...
        onSelectRow: function (id) {
            ...
            $('#txtaccountcode').val($(this).getRowData(id).accountcode);
            $('#txtaccountname').val($(this).getRowData(id).title);
