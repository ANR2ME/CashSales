                ...
                rows = (
                    ...
                    select new
                    {
                        ...
                        cell = new object[] {
                            ...
                            model.SourceCashBankName, //_cashBankService.GetObjectById(model.SourceCashBankId).Name,
                            model.TargetCashBankId,
                            model.TargetCashBankName, //_cashBankService.GetObjectById(model.TargetCashBankId).Name,
                            model.Amount,
                            model.IsConfirmed,
